...
public class PoiSearchDemo extends Activity {
    ...
    private static String name = PoiSearchDemo.class.getName();
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	double s1 = SystemClock.uptimeMillis();
    	//log.info(Double.toString(s1) );// 
    //	Log.i("Running time start of oncreat",s1 +"");
    	Log.i("Running time start of oncreat s1",s1 +""); //这两种写法都可以
        ...
        double s2 = SystemClock.uptimeMillis();
    	Log.i("Running time s2",s2 +""); //这两种写法都可以
        ...
        mSearch.init(app.mBMapManager, new MKSearchListener(){
            ...
            public void onGetPoiResult(MKPoiResult res, int type, int error) {
            	...
            	double s5 = SystemClock.uptimeMillis();
            	Log.i("Running time start of getpoiresult s5",s5 +"");
                ...
                if (res.getCurrentNumPois() > 0) {
                    ...
                    double s6 = SystemClock.uptimeMillis();
                	Log.i("Running time end of app s6",s6 +"");
            ...
            public void onGetAddrResult(MKAddrInfo res, int error) {
            	...
            	double s4 = SystemClock.uptimeMillis();
            	Log.i("Running time start of getaddrresult s4",s4 +"");
    ...
    public void searchButtonProcess(View v) {
    	...
    	double s3 = SystemClock.uptimeMillis();
    	Log.i("Running time start of geocode s3",s3 +"");
